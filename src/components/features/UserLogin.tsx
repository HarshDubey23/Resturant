...
import { ArrowLeft, ArrowRight, MessageSquare, Phone, ShieldCheck } from "lucide-react";
						...
						{debugOtp && (
							<div className="rounded-lg bg-amber-50 border border-amber-200 p-3 text-center">
								<p className="text-xs text-amber-700">
									<span className="font-semibold">Dev mode OTP:</span> <span className="font-mono text-base font-bold tracking-wider">{debugOtp}</span>
								</p>
							</div>
						)}
