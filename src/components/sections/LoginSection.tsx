                                ...
                                <div className="grid lg:grid-cols-2 gap-16 items-center">
                                        <motion.div
                                                ...
                                                <div className="relative w-72 h-80 rounded-3xl overflow-hidden shadow-2xl glow-primary mb-8">
                                                        <img src="https://images.unsplash.com/photo-1603894584373-5ac82b2ae398?w=600&h=800&fit=crop" alt="Restaurant kitchen" className="w-full h-full object-cover" />
                                                ...
                                                <p className="text-muted-foreground mt-3 max-w-sm leading-relaxed">Sign in to manage your restaurant, view orders, and access the kitchen display.</p>
                                        </motion.div>
