...
export default function CtaSection() {
	return (
		<section className="relative py-28 sm:py-36 overflow-hidden bg-slate-50">
			{/* Background effects */}
			...
			<div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
				<motion.div
					...
					<div className="inline-flex items-center gap-2 rounded-full border border-slate-200/50 bg-white/80 px-4 py-1.5 text-sm text-slate-500 mb-8 shadow-soft">
					...
					<div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
						...
						<Link href="/demo?tab=menu">
							<Button variant="outline" size="lg" className="gap-2 text-base h-13 px-10 rounded-xl transition-all duration-200">
								Try Live Demo
							</Button>
						</Link>
					</div>
