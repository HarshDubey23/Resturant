...
export async function GET() {
        ...
        try {
                ...
                // NOTE: Auth bypassed when DEMO_MODE=true — initial bootstrap only.
                // Re-enable auth check before going to production.
                const session = process.env.DEMO_MODE === "true" ? null : await getServerSession(authOptions);
