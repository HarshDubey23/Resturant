...
import { Award, BarChart3, FileText, HandCoins, LayoutDashboard, Megaphone, MessageCircleHeart, ReceiptText, Settings2, ShoppingBag } from "lucide-react";
...
const navItems = [
        ...
        { label: "cashier", icon: <ReceiptText className="h-5 w-5" />, value: "cashier" },
        { label: "analytics", icon: <BarChart3 className="h-5 w-5" />, value: "analytics" },
        { label: "staff-tips", icon: <HandCoins className="h-5 w-5" />, value: "staff-tips" },
        { label: "feedback", icon: <MessageCircleHeart className="h-5 w-5" />, value: "feedback" },
