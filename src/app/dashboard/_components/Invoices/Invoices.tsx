        ...
        return (
                <div className="space-y-6">
                        ...
                        <Dialog
							...
							<DialogDescription>Preview of the invoice as it appears to the customer. Use the download button to save as PDF.</DialogDescription>
						</DialogHeader>
                                                                ...
                                                                order={
                                                                        {
                                                                                ...
                                                                                // Use the actual invoice date, not today
                                                                                        createdAt: (selectedInvoice as unknown as { generatedAt?: Date }).generatedAt
                                                                                                || (selectedInvoice.order as unknown as { createdAt?: Date }).createdAt
                                                                                                || new Date(),
