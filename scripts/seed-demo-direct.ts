...
async function main() {
	...
	console.log(`  empire: ${empireResult.menus.length} menus, ${empireResult.tables.length} tables (${empireResult.processTime.toFixed(2)}s)`);
	console.log(`  brewpoint: ${brewpointResult.menus.length} menus, ${brewpointResult.tables.length} tables (${brewpointResult.processTime.toFixed(2)}s)`);
	console.log(`  spiceroute: ${spicerouteResult.menus.length} menus, ${spicerouteResult.tables.length} tables (${spicerouteResult.processTime.toFixed(2)}s)`);
	console.log(`  demo: ${demoResult.menus.length} menus, ${demoResult.tables.length} tables (${demoResult.processTime.toFixed(2)}s)`);
